  ...
  return (
    <PageBackground variant="light">
      <div>
        ...
        <section className="py-16 md:py-20 lg:py-24 mt-0 bg-primary/5">
          <div className="container space-y-8 px-4 md:px-6">
            ...
            <div className="mx-auto max-w-4xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <SpotlightContainer className="space-y-4 animate-fade-in-up">
                ...
                <SpotlightContainer className="space-y-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                ...
                <SpotlightContainer className="space-y-4 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
                ...
                <SpotlightContainer className="space-y-4 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
        ...
        <section className="py-16 md:py-20 lg:py-24">
          <div className="container space-y-8 px-4 md:px-6">
            ...
            <div className="mx-auto max-w-4xl space-y-6 mt-8">
              <SpotlightContainer className="rounded-lg p-6 animate-fade-in-up bg-primary/5">
              ...
              <SpotlightContainer className="rounded-lg p-6 animate-fade-in-up bg-primary/5" style={{ animationDelay: "0.2s" }}>
                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <Briefcase className="h-5 w-5 text-primary" />
              ...
              <SpotlightContainer className="rounded-lg p-6 animate-fade-in-up bg-primary/5" style={{ animationDelay: "0.3s" }}>
                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <Briefcase className="h-5 w-5 text-primary" />
...
function SkillBadge({ name, delay = 0 }: { name: string; delay?: number }) {
  return (
    <Badge
      variant="secondary"
      className="animate-fade-in-up text-sm py-1.5 px-3 bg-primary/10 hover:bg-primary/30 hover:shadow-lg hover:scale-110 hover:-translate-y-1 transition-all duration-200 text-foreground font-medium"
...
function ProjectCard({
  ...
  return (
    <SpotlightContainer 
      className="rounded-lg p-6 hover:shadow-xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 animate-fade-in-up bg-background" 
      style={{ 

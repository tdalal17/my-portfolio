...
export function HeroSection({ name, title, description, profileImage }: HeroSectionProps) {
  ...
  return (
    <section 
      className="min-h-[90vh] flex items-center justify-center pt-16 md:pt-24 pb-10 md:pb-16 overflow-hidden relative animate-fade-in"
      style={{ 
        opacity: mounted ? 1 : 0,
    ...
    >
      ...
      <div className="container px-4 md:px-6">
        <div className="grid items-center gap-8 lg:gap-12 xl:grid-cols-2">
          <div className="flex flex-col items-center space-y-6 text-center xl:items-start xl:text-left">
          ...
          <div className="flex items-center justify-center xl:justify-end">
            <div 
              className="relative max-w-[400px] w-full mx-auto animate-fade-in"
              style={{ 
                animationDelay: '0.2s',
                opacity: mounted ? 1 : 0,
                transform: mounted ? 'translateY(0)' : 'translateY(20px)',
